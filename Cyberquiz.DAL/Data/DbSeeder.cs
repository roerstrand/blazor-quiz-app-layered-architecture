...
namespace Cyberquiz.DAL.Data
{
    public static class DbSeeder
    {
        public static async Task SeedAsync(AppDbContext context)
        {
            ...
            var catNatverk      = new CategoryModel { Name = "Nätverk" };
            var catWebbsak      = new CategoryModel { Name = "Webbsäkerhet" };
            var catKrypto       = new CategoryModel { Name = "Kryptografi" };
            var catMalware      = new CategoryModel { Name = "Malware & Attacker" };
            var catOS           = new CategoryModel { Name = "Operativsystem" };
            var catLagstiftning = new CategoryModel { Name = "Lagstiftning & Compliance" };

            var subTCPIP        = new SubCategoryModel { Name = "TCP/IP-grunderna",          Order = 1, Category = catNatverk };
            var subDNS          = new SubCategoryModel { Name = "DNS & DHCP",                Order = 2, Category = catNatverk };
            var subBrandvaggar  = new SubCategoryModel { Name = "Brandväggar & IDS/IPS",     Order = 3, Category = catNatverk };

            var subOwasp        = new SubCategoryModel { Name = "OWASP Top 10",              Order = 1, Category = catWebbsak };
            var subInjektioner  = new SubCategoryModel { Name = "XSS & Injektioner",         Order = 2, Category = catWebbsak };
            var subAutentisering= new SubCategoryModel { Name = "Autentisering & Sessions",  Order = 3, Category = catWebbsak };

            var subSymKrypto    = new SubCategoryModel { Name = "Symmetrisk kryptering",     Order = 1, Category = catKrypto };
            var subAsymKrypto   = new SubCategoryModel { Name = "Asymmetrisk kryptering & PKI", Order = 2, Category = catKrypto };
            var subHashning     = new SubCategoryModel { Name = "Hashning",                  Order = 3, Category = catKrypto };

            var subMalwaretyper = new SubCategoryModel { Name = "Malwaretyper",              Order = 1, Category = catMalware };
            var subAttackmetoder= new SubCategoryModel { Name = "Attackmetoder",             Order = 2, Category = catMalware };
            var subSocialEng    = new SubCategoryModel { Name = "Social Engineering",        Order = 3, Category = catMalware };

            var subLinux        = new SubCategoryModel { Name = "Linux-säkerhet",            Order = 1, Category = catOS };
            var subWindows      = new SubCategoryModel { Name = "Windows-säkerhet",          Order = 2, Category = catOS };
            var subBehorighet   = new SubCategoryModel { Name = "Behörighetshantering",      Order = 3, Category = catOS };

            var subGdpr         = new SubCategoryModel { Name = "GDPR",                      Order = 1, Category = catLagstiftning };
            var subNis2         = new SubCategoryModel { Name = "NIS2 & ISO 27001",          Order = 2, Category = catLagstiftning };
            var subIncident     = new SubCategoryModel { Name = "Incident Response",         Order = 3, Category = catLagstiftning };
